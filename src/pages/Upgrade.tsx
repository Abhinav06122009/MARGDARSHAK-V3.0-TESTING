    ...
    <div className="min-h-screen bg-[#030303] text-gray-300 font-sans selection:bg-amber-500/30 overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-8 md:py-16">
        ...
        >
          ...
          <div className="bg-amber-500/10 border border-amber-500/20 rounded-2xl p-6 text-left max-w-2xl mx-auto flex gap-4 items-start shadow-xl">
            <div className="bg-amber-500/20 p-3 rounded-full shrink-0">
              <Info className="w-6 h-6 text-amber-500" />
            </div>
            <div>
              <h3 className="text-amber-500 font-bold text-lg mb-2 tracking-wide uppercase">Important Notice</h3>
              <p className="text-gray-300 text-sm leading-relaxed">
                <strong className="text-white">VSAV GYANTAPA</strong> does a manual verification after payment. Kindly share your payment screenshot or invoice along with your account details to our team. We will activate your subscription within 24-48 hrs.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <motion.div variants={itemVariants} className="relative p-8 rounded-[2.5rem] bg-[#0A0A0A] border border-white/5">
            ...
            {currentTier === 'free' ? (
              <button className="w-full py-6 rounded-xl border border-emerald-500/50 bg-emerald-500/10 text-emerald-400 font-bold text-lg cursor-default">
                Your Current Plan
              </button>
            ) : (
              <button className="w-full py-6 rounded-xl border border-white/10 text-white font-bold text-lg hover:bg-white/5 transition-colors cursor-default opacity-50">
                Free Plan
              </button>
            )}
          ...
          >
            ...
            {currentTier === 'premium_elite' ? (
              <button className="w-full py-6 rounded-xl border border-emerald-500/50 bg-emerald-500/10 text-emerald-400 font-bold text-lg cursor-default shadow-[0_0_20px_rgba(16,185,129,0.2)]">
                Your Current Plan
              </button>
            ) : (
              <div onClick={() => {
