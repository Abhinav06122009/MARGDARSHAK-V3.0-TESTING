      ...
      <div className="flex items-center justify-between mb-10">
         <div className="flex items-center gap-4">
            ...
            <div>
               ...
               <p className="text-[10px] font-black text-white/20 uppercase tracking-[0.2em] mt-1">Credential Archival</p>
            </div>
         </div>
      ...
      <form onSubmit={onSubmit} className="space-y-8 relative z-10">
        <div className="space-y-3">
          <label className="text-[10px] font-black text-white/30 uppercase tracking-[0.4em] ml-2 flex items-center gap-3">
             <KeyRound size={12} className="text-emerald-500/40" /> New Cipher
          </label>
        ...
        <div className="space-y-3">
          <label className="text-[10px] font-black text-white/30 uppercase tracking-[0.4em] ml-2 flex items-center gap-3">
             <Fingerprint size={12} className="text-emerald-500/40" /> Handshake Confirm
          </label>
          <input
            type={showPassword ? 'text' : 'password'}
        ...
        >
          ...
          {isSubmitting ? 'Encoding Core...' : 'Finalize Cipher Sync'}
        </button>
      </form>
